        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contacts_EducationCategories_EducationCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    EduCategoryId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contacts_EducationCategoryId",
                table: "Contacts",
                column: "EducationCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Groups_EducationCategoryId",
                table: "Groups",
                column: "EducationCategoryId");
